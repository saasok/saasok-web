...
const RISK_OPTIONS: {
...
}[] = [
  {
    ...
    label: "Conservative",
    sub: "Bonds + ETFs",
    background: "linear-gradient(160deg,#2E5C8A,#1F3F63)",
  },
  {
    value: "moderate",
    label: "Moderate",
    sub: "Stocks + Funds + FX",
    background: "linear-gradient(160deg,#3B6E52,#284A38)",
  },
  {
    value: "aggressive",
    label: "Aggressive",
    sub: "Stocks + Futures + Options",
    background: "linear-gradient(160deg,#8A4A3B,#602F24)",
  },
];
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center px-10 py-9">
      ...
      <div className="mb-9 max-w-xl text-center font-fraunces text-2xl font-semibold leading-snug">
        What is your portfolio risk level?
      </div>
