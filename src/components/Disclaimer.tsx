export function Disclaimer() {
  return (
    ...
    >
      ...
      or advisory services and does not manage users&apos; assets or funds.
      Nothing provided through the platform constitutes advice or a
      recommendation. Users remain solely responsible for their own
      decisions.
    </div>
  );
}
